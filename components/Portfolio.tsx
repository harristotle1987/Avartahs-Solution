...
import { ArrowUpRight, ExternalLink, Cpu, Layout, MessageSquare, Camera, Download, Loader2, AlertCircle, Activity, Trophy, Shield } from 'lucide-react';

const projects = [
  { 
    title: "AegisVault", 
    category: "Local-First PWA", 
    description: "A sovereign, local-first Markdown editor with high-performance document processing. Features zero cloud dependency, neural-ready text-to-speech, and universal import/export.", 
    realScreenshot: "https://images.unsplash.com/photo-1542831371-29b0f74f9713?q=80&w=2070&auto=format&fit=crop", 
    link: "https://aegis-vault-pi.vercel.app/", 
    icon: <Shield size={14} />, 
    metrics: "100% Local Encryption" 
  },
  { 
    title: "IHS Athletic Matrix", 
    category: "Web (PWA) & Android", 
    description: "High-performance sports management platform built for University Preparatory Secondary School (UPSS). Orchestrates inter-house competitions with real-time scoring, roster management, and live telemetry.", 
    realScreenshot: "https://images.unsplash.com/photo-1461896836934-ffe607ba8211?q=80&w=2070&auto=format&fit=crop", 
    link: "https://interhouse-sports-management-platfo.vercel.app/", 
    icon: <Trophy size={14} />, 
    metrics: "Live Telemetry Feed" 
  },
  { 
